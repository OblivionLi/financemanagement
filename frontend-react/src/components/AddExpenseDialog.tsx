...
const AddExpenseDialog: React.FC<IExpenseAddModalProps> = ({open, onClose}) => {
    ...
    const [currencies, setCurrencies] = useState<ICurrencyData[]>([]);
    ...
    const fetchCurrencies = async () => {
        ExpensesService.getCurrencies()
            .then((response: any) => {
                setCurrencies(response.data as ICurrencyData[])
            })
            .catch((e: Error) => {
                console.log(e);
            });
                ...
                <Paper elevation={3}
                    ...
                    <form onSubmit={handleSubmit}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12}>
                                {newSubcategoryMessage ?? <Alert severity="success"></Alert>}
                            ...
                            <Grid item xs={12}>
                                <Alert severity="info" sx={{marginBottom: '1rem'}}>Internally all finances are based on EUR.</Alert>
